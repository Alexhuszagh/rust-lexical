...
![Uniform Random Data](/lexical-parse-integer/assets/random_uniform_features=radix.svg)
...
![Simple Random Data](/lexical-parse-integer/assets/random_simple_features=radix.svg)

**Large**

A benchmark on randomly-generated, large numbers to test parsing numbers with many digits.

![Large Random Data](/lexical-parse-integer/assets/random_large_features=radix.svg)
...
![Simple Negative Random Data](/lexical-parse-integer/assets/random_simple_signed_features=radix.svg)

**Large Negative**

A benchmark on randomly-generated, large, negative numbers to test parsing negative numbers with many digits.

![Large Negative Random Data](/lexical-parse-integer/assets/random_large_signed_features=radix.svg)
...
![JSON Simple Data](/lexical-parse-integer/assets/json_simple_features=radix.svg)
...
![JSON Random Data](/lexical-parse-integer/assets/json_random_features=radix.svg)
