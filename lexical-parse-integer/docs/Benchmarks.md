...
These benchmarks were run on an `Intel(R) Core(TM) i7-6560U CPU @ 2.20GHz` processor, on Linux 5.12.5/Fedora 34, and run against commit [3fe46c2](https://github.com/Alexhuszagh/rust-lexical-experimental/3fe46c2f525c1293fc09be6878fcbf1f506ccc32). The exact code and data used to run the benchmark can be seen [here](/lexical-benchmark/parse-integer).
