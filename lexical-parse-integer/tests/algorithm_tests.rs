...
//        algorithm::try_parse_4digits::<u32, _, STANDARD>(&mut bytes.integer_iter())
//    };
...
//    let parse = |digits: &[u8]| {
//        let mut bytes = digits.noskip();
//        algorithm::try_parse_8digits::<u64, _, STANDARD>(&mut bytes.integer_iter())
//    };
//
...
//        let mut bytes = digits.noskip();
//        algorithm::algorithm::<u32, _, STANDARD>(bytes.integer_iter())
//    };
//    let parse_i32 = |digits: &[u8]| {
//        let mut bytes = digits.noskip();
//        algorithm::algorithm::<i32, _, STANDARD>(bytes.integer_iter())
//    };
//
...
//        let mut bytes = digits.noskip();
//        algorithm::algorithm_128::<u128, _, STANDARD>(bytes.integer_iter())
//    };
//    let parse_i128 = |digits: &[u8]| {
//        let mut bytes = digits.noskip();
//        algorithm::algorithm_128::<i128, _, STANDARD>(bytes.integer_iter())
//    };
//
