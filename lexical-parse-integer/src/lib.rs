...
//! # Design
//!
//! - [Algorithm Approach](https://github.com/Alexhuszagh/rust-lexical-experimental/blob/main/lexical-parse-integer/docs/Algorithm.md)
//! - [Benchmarks](https://github.com/Alexhuszagh/rust-lexical-experimental/blob/main/lexical-parse-integer/docs/Benchmarks.md)
