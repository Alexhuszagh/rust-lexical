// TODO(ahuszagh) Rename to compact
#![cfg(feature = "compact")]
...
where
    T: Integer,
{
    algorithm!(bytes, FORMAT, T, parse_compact, invalid_digit_err, into_ok_value)
}
...
where
    T: Integer,
{
    algorithm!(bytes, FORMAT, T, parse_compact, invalid_digit_ok, into_ok_index)
}
