...
cfg_if! {
if #[cfg(not(feature = "radix"))] {
pub const BASE10_POWERS: [(u64, u64); 651] = [
    ...
    (0xd43bf0effdc0ba48, 0x212bd1b2566def2),            // 10^-327
    (0x84a57695fe98746d, 0x14bb630f7604b57),            // 10^-326
    ...
    (0xaf8e5410288e1b6f, 0x7ecf0ae5ee44dd9),            // 10^-303
    ...
    (0xd64d3d9db981787d, 0x92cbbccdad5b108),            // 10^-299
    ...
    (0xd3515c2831559a83, 0xd5a5b44ca873e03),            // 10^-268
    ...
    (0x92a1958a7675175f, 0xbfacd89ec191ec9),            // 10^-251
    ...
    (0xb4bca50b065abe63, 0xfed077a756b53a9),            // 10^-219
    ...
    (0x806bd9714632dff6, 0xba1cd8a3db53b6),             // 10^-205
    ...
    (0xe65829b3046b0afa, 0xcb4a5a3112a5112),            // 10^-162
    ...
    (0xab9eb47c81f5114f, 0x66ea92f3f326564),            // 10^-154
    ...
    (0x9c1661a651213e2d, 0x6bea10ca65c084e),            // 10^-142
    ...
    (0x915e2486ef32cd60, 0xace1474dc1d122e),            // 10^-133
    (0xb5b5ada8aaff80b8, 0xd819992132456ba),            // 10^-132
    ...
    (0x811ccc668829b887, 0x806357d5a3f525f),            // 10^-118
    ...
    (0xc5029163f384a931, 0xa9e795e65d4df11),            // 10^-113
    ...
    (0xb77ada0617e3bbcb, 0x9ce6ebb40173744),            // 10^-104
    ...
    (0x9f24b832e6b0f436, 0xdd9ca7d2df4d7c9),            // 10^-86
    ...
    (0xcad2f7f5359a3b3e, 0x96ee45813a04330),            // 10^-29
    ...
    (0xb877aa3236a4b449, 0x9befeb9fad487c2),            // 10^-17
    (0xe69594bec44de15b, 0x4c2ebe687989a9b3),           // 10^-16
    (0x901d7cf73ab0acd9, 0xf9d37014bf60a10),            // 10^-15
    ...
    (0xa7c5ac471b478423, 0xfcf80dc33721d53),            // 10^-5
    ...
    (0x8000000000000000, 0x0),                          // 10^0
    (0xa000000000000000, 0x0),                          // 10^1
    (0xc800000000000000, 0x0),                          // 10^2
    (0xfa00000000000000, 0x0),                          // 10^3
    (0x9c40000000000000, 0x0),                          // 10^4
    (0xc350000000000000, 0x0),                          // 10^5
    (0xf424000000000000, 0x0),                          // 10^6
    (0x9896800000000000, 0x0),                          // 10^7
    (0xbebc200000000000, 0x0),                          // 10^8
    (0xee6b280000000000, 0x0),                          // 10^9
    (0x9502f90000000000, 0x0),                          // 10^10
    (0xba43b74000000000, 0x0),                          // 10^11
    (0xe8d4a51000000000, 0x0),                          // 10^12
    (0x9184e72a00000000, 0x0),                          // 10^13
    (0xb5e620f480000000, 0x0),                          // 10^14
    (0xe35fa931a0000000, 0x0),                          // 10^15
    (0x8e1bc9bf04000000, 0x0),                          // 10^16
    (0xb1a2bc2ec5000000, 0x0),                          // 10^17
    (0xde0b6b3a76400000, 0x0),                          // 10^18
    (0x8ac7230489e80000, 0x0),                          // 10^19
    (0xad78ebc5ac620000, 0x0),                          // 10^20
    (0xd8d726b7177a8000, 0x0),                          // 10^21
    (0x878678326eac9000, 0x0),                          // 10^22
    (0xa968163f0a57b400, 0x0),                          // 10^23
    (0xd3c21bcecceda100, 0x0),                          // 10^24
    (0x84595161401484a0, 0x0),                          // 10^25
    (0xa56fa5b99019a5c8, 0x0),                          // 10^26
    (0xcecb8f27f4200f3a, 0x0),                          // 10^27
    ...
    (0xfee50b7025c36a08, 0x2f236d04753d5b4),            // 10^59
    (0x9f4f2726179a2245, 0x1d762422c946590),            // 10^60
    ...
    (0xc913936dd571c84c, 0x3bc3a19cd1e38e9),            // 10^89
    (0xfb5878494ace3a5f, 0x4ab48a04065c723),            // 10^90
    ...
    (0xe498f455c38b997a, 0xb6dfb9c0f956447),            // 10^102
    ...
    (0x850fadc09923329e, 0x3e2cf6bc604ddb0),            // 10^112
    ...
    (0xc1a12d2fc3978937, 0x52d6b1641c83ae),             // 10^123
    ...
    (0xabfa45da0edbde69, 0x487db9d17636892),            // 10^138
    (0xd6f8d7509292d603, 0x45a9d2845d3c42b6),           // 10^139
    (0x865b86925b9bc5c2, 0xb8a2392ba45a9b2),            // 10^140
    ...
    (0xc56baec21c7a1916, 0x88aaa1845b8fdd0),            // 10^179
    ...
    (0x9316ff75dd87cbd8, 0x9a7f12442d588f2),            // 10^187
    (0xb7dcbf5354e9bece, 0xc11ed6d538aeb2f),            // 10^188
    ...
    (0xdb2e51bfe9d0696a, 0x6997b05fcc0319e),            // 10^195
    ...
    (0x9f79a169bd203e41, 0xf0062c6e984d386),            // 10^206
    ...
    (0xf356f7ebf83552fe, 0x583f6b8c4124d43),            // 10^211
    ...
    (0xe4d5e82392a40515, 0xfabaf3feaa5334a),            // 10^248
    ...
    (0xe7109bfba19c0c9d, 0xcc512670a783ad4),            // 10^276
    ...
    (0xc3b8358109e84f07, 0xa862f80ec4700c8),            // 10^297
    ...
    (0x95527a5202df0ccb, 0xf37801e0c43ebc8),            // 10^302
...
pub const BASE10_BIAS: i32 = 342;
pub const BASE10_MIN_EXP: i32 = -342;
pub const BASE10_MAX_EXP: i32 = 308;
}}  // cfg_if

// SMALL POWERS - BASE10
pub const BASE10_INT_POWERS: [u64; 16] = [
    1,                        // 10^0
    10,                       // 10^1
    100,                      // 10^2
    1000,                     // 10^3
...
pub const BASE10_F32_POWERS: [f32; 11] = [
    1.0,                      // 10^0
    10.0,                     // 10^1
    100.0,                    // 10^2
    1000.0,                   // 10^3
...
pub const BASE10_F64_POWERS: [f64; 23] = [
    1.0,                      // 10^0
    10.0,                     // 10^1
    100.0,                    // 10^2
    1000.0,                   // 10^3
