...
#[inline(always)]
pub(super) fn ltrim_zero_no_separator<'a>(bytes: &'a [u8], _: u8) -> (&'a [u8], usize) {
...
#[inline(always)]
#[cfg(feature = "format")]
pub(super) fn ltrim_zero_separator<'a>(bytes: &'a [u8], digit_separator: u8) -> (&'a [u8], usize) {
...
/// Does not consume any digit separators.
#[inline]
pub(super) fn ltrim_separator_no_separator<'a>(bytes: &'a [u8], _: u8) -> (&'a [u8], usize) {
    (bytes, 0)
}
...
#[inline(always)]
#[cfg(feature = "format")]
pub(super) fn ltrim_separator_separator<'a>(
    bytes: &'a [u8],
    digit_separator: u8,
) -> (&'a [u8], usize) {
...
/// Does not consume any digit separators.
#[inline(always)]
pub(super) fn rtrim_zero_no_separator<'a>(bytes: &'a [u8], _: u8) -> (&'a [u8], usize) {
...
#[inline(always)]
#[cfg(feature = "format")]
pub(super) fn rtrim_zero_separator<'a>(bytes: &'a [u8], digit_separator: u8) -> (&'a [u8], usize) {
...
/// Does not consume any digit separators.
#[inline(always)]
pub(super) fn rtrim_separator_no_separator<'a>(bytes: &'a [u8], _: u8) -> (&'a [u8], usize) {
    (bytes, 0)
}
...
#[inline(always)]
#[cfg(feature = "format")]
pub(super) fn rtrim_separator_separator<'a>(
    bytes: &'a [u8],
    digit_separator: u8,
) -> (&'a [u8], usize) {
