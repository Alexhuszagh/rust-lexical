...
mod tests {
    ...
    fn extract_test() {
        IgnoreFastDataInterface::new(NumberFormat::ignore(b'_').unwrap()).run_tests([
            // Valid
            ("1.2345", Ok(ignore!(b"1", b"2345", b"", 0))),
            ("12.345", Ok(ignore!(b"12", b"345", b"", 0))),
            ("12345.6789", Ok(ignore!(b"12345", b"6789", b"", 0))),
            ("1.2345e10", Ok(ignore!(b"1", b"2345", b"e10", 10))),
            ("1.2345e+10", Ok(ignore!(b"1", b"2345", b"e+10", 10))),
            ("1.2345e-10", Ok(ignore!(b"1", b"2345", b"e-10", -10))),
            ("100000000000000000000", Ok(ignore!(b"100000000000000000000", b"", b"", 0))),
            ("100000000000000000001", Ok(ignore!(b"100000000000000000001", b"", b"", 0))),
            ...
            ("1009e-31", Ok(ignore!(b"1009", b"", b"e-31", -31))),
            ("001.0", Ok(ignore!(b"1", b"", b"", 0))),
            ("1.", Ok(ignore!(b"1", b"", b"", 0))),
            ("12.", Ok(ignore!(b"12", b"", b"", 0))),
            ("1234567.", Ok(ignore!(b"1234567", b"", b"", 0))),
            (".1", Ok(ignore!(b"", b"1", b"", 0))),
            (".12", Ok(ignore!(b"", b"12", b"", 0))),
            (".1234567", Ok(ignore!(b"", b"1234567", b"", 0))),
            ("1.2345e", Ok(ignore!(b"1", b"2345", b"e", 0))),
            (".3e", Ok(ignore!(b"", b"3", b"e", 0))),
            ("_1.2345_e_+_10", Ok(ignore!(b"1", b"2345", b"e_+_10", 10))),
            ("12__1_._23__45e+1__0_", Ok(ignore!(b"12__1_", b"_23__45", b"e+1__0_", 10))),
