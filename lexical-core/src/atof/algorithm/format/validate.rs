...
#[inline(always)]
fn is_integer_empty<'a, Data>(data: &Data) -> bool
where
...
#[inline(always)]
fn is_fraction_empty<'a, Data>(data: &Data) -> bool
where
    Data: FastDataInterface<'a>,
{
...
#[inline(always)]
#[cfg(feature = "format")]
fn has_fraction<'a, Data>(data: &Data) -> bool
where
    Data: FastDataInterface<'a>,
{
...
#[inline(always)]
fn has_exponent<'a, Data>(data: &Data) -> bool
where
    Data: FastDataInterface<'a>,
{
...
#[inline(always)]
#[cfg(feature = "format")]
fn last_mantissa_as_ptr<'a, Data>(data: &Data) -> *const u8
where
    Data: FastDataInterface<'a>,
{
    ...
    Data: FastDataInterface<'a>,
{
    ...
    match iter.next() {
        Some(&b'+') | Some(&b'-') => Ok(()),
        _ if has_exponent(data) => {
            Err((ErrorCode::MissingExponentSign, option_as_ptr(data.exponent())))
        },
        _ => Ok(()),
    }
}
    ...
    Data: FastDataInterface<'a>,
{
    ...
    match iter.next() {
        Some(&b'+') => {
            Err((ErrorCode::InvalidPositiveExponentSign, option_as_ptr(data.exponent())))
        },
        _ => Ok(()),
    }
}
