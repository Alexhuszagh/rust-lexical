...
mod tests {
    ...
    fn trailing_zero_limbs_test() {
        ...
        assert_eq!(Bigint { data: vector![0xFF] }.trailing_zero_limbs(), 0);
        assert_eq!(Bigint { data: vector![0, 0xFF000] }.trailing_zero_limbs(), 1);
        assert_eq!(Bigint { data: vector![0, 0, 0, 0xFF000] }.trailing_zero_limbs(), 3);
    }
    ...
    fn pad_zero_digits_test() {
        let mut x = Bigint { data: vector![0, 0, 0, 1] };
        x.pad_zero_digits(3);
        assert_eq!(x.data.as_slice(), &[0, 0, 0, 0, 0, 0, 1]);

        let mut x = Bigint { data: vector![1] };
        x.pad_zero_digits(1);
