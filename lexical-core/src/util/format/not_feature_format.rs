...
bitflags! {
    ...
    /// a b'e' character for the decimal exponent, and a b'^' character
    /// for the backup exponent.
    ///
    /// Bit Flags Layout
    /// ----------------
    ///
    ...
    /// decimal point, decimal exponent, and backup exponent, allowing
    /// any valid ASCII character as punctuation. Bits 18-25 for the
    /// decimal exponent character, bits 25-32 for the backup exponent
