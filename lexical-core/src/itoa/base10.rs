...
mod tests {
    use util::test::*;
    use super::*;
    // We need extra tests because of how specific the backend is to
    // ensure it's working.
    ...
    macro_rules! check_internal {
        ($value:expr, $expected:expr, $cb:ident, $t:tt) => {
            ...
            let count = $cb($value, digits);
            assert_eq!($expected.len(), count);
            assert_eq!(&$expected[..], &digits[..count]);
        };
    }
    ...
    fn u8toa_test() {
        ...
        for (i, s) in values.iter() {
            check_internal!(*i, s, u8toa, u8);
        }
    }
    ...
    fn u32toa_test() {
        let values: &[(u32, &[u8])] = &[
            ...
            (100000001, b"100000001"),
            (100000005, b"100000005"),
            (999999999, b"999999999"),
            (1000000000, b"1000000000"),
            (1000000001, b"1000000001"),
            (1000000005, b"1000000005"),
            (2147483647, b"2147483647"),
            (2147483648, b"2147483648"),
            (4294967295, b"4294967295"),
        ];
        for (i, s) in values.iter() {
            check_internal!(*i, s, u32toa, u32);
        }
    }
    ...
    fn u64toa_test() {
        let values: &[(u64, &[u8])] = &[
            ...
            (10000000001, b"10000000001"),
            (10000000005, b"10000000005"),
            (99999999999, b"99999999999"),
            (100000000000, b"100000000000"),
            (100000000001, b"100000000001"),
            (100000000005, b"100000000005"),
            (999999999999, b"999999999999"),
            (1000000000000, b"1000000000000"),
            (1000000000001, b"1000000000001"),
            (1000000000005, b"1000000000005"),
            (9999999999999, b"9999999999999"),
            (10000000000000, b"10000000000000"),
            (10000000000001, b"10000000000001"),
            (10000000000005, b"10000000000005"),
            (99999999999999, b"99999999999999"),
            (100000000000000, b"100000000000000"),
            (100000000000001, b"100000000000001"),
            (100000000000005, b"100000000000005"),
            (999999999999999, b"999999999999999"),
            (1000000000000000, b"1000000000000000"),
            (1000000000000001, b"1000000000000001"),
            (1000000000000005, b"1000000000000005"),
            (9999999999999999, b"9999999999999999"),
            (10000000000000000, b"10000000000000000"),
            (10000000000000001, b"10000000000000001"),
            (10000000000000005, b"10000000000000005"),
            (99999999999999999, b"99999999999999999"),
            (100000000000000000, b"100000000000000000"),
            (100000000000000001, b"100000000000000001"),
            (100000000000000005, b"100000000000000005"),
            (999999999999999999, b"999999999999999999"),
            (1000000000000000000, b"1000000000000000000"),
            (1000000000000000001, b"1000000000000000001"),
            (1000000000000000005, b"1000000000000000005"),
    ...
    fn u128toa_test() {
        let values: &[(u128, &[u8])] = &[
            ...
            (1000000000000000001, b"1000000000000000001"),
            (1000000000000000005, b"1000000000000000005"),
            (9999999999999999999, b"9999999999999999999"),
            (10000000000000000000, b"10000000000000000000"),
            (10000000000000000001, b"10000000000000000001"),
            (10000000000000000005, b"10000000000000000005"),
            (99999999999999999999, b"99999999999999999999"),
            (100000000000000000000, b"100000000000000000000"),
            (100000000000000000001, b"100000000000000000001"),
            (100000000000000000005, b"100000000000000000005"),
            (999999999999999999999, b"999999999999999999999"),
            (1000000000000000000000, b"1000000000000000000000"),
            (1000000000000000000001, b"1000000000000000000001"),
            (1000000000000000000005, b"1000000000000000000005"),
            (9999999999999999999999, b"9999999999999999999999"),
            (10000000000000000000000, b"10000000000000000000000"),
            (10000000000000000000001, b"10000000000000000000001"),
            (10000000000000000000005, b"10000000000000000000005"),
            (99999999999999999999999, b"99999999999999999999999"),
            (100000000000000000000000, b"100000000000000000000000"),
            (100000000000000000000001, b"100000000000000000000001"),
            (100000000000000000000005, b"100000000000000000000005"),
            (999999999999999999999999, b"999999999999999999999999"),
            (1000000000000000000000000, b"1000000000000000000000000"),
            (1000000000000000000000001, b"1000000000000000000000001"),
            (1000000000000000000000005, b"1000000000000000000000005"),
            (9999999999999999999999999, b"9999999999999999999999999"),
            (10000000000000000000000000, b"10000000000000000000000000"),
            (10000000000000000000000001, b"10000000000000000000000001"),
            (10000000000000000000000005, b"10000000000000000000000005"),
            (99999999999999999999999999, b"99999999999999999999999999"),
            (100000000000000000000000000, b"100000000000000000000000000"),
            (100000000000000000000000001, b"100000000000000000000000001"),
            (100000000000000000000000005, b"100000000000000000000000005"),
            (999999999999999999999999999, b"999999999999999999999999999"),
            (1000000000000000000000000000, b"1000000000000000000000000000"),
            (1000000000000000000000000001, b"1000000000000000000000000001"),
            (1000000000000000000000000005, b"1000000000000000000000000005"),
            (9999999999999999999999999999, b"9999999999999999999999999999"),
            (10000000000000000000000000000, b"10000000000000000000000000000"),
            (10000000000000000000000000001, b"10000000000000000000000000001"),
            (10000000000000000000000000005, b"10000000000000000000000000005"),
            (99999999999999999999999999999, b"99999999999999999999999999999"),
            (100000000000000000000000000000, b"100000000000000000000000000000"),
            (100000000000000000000000000001, b"100000000000000000000000000001"),
            (100000000000000000000000000005, b"100000000000000000000000000005"),
            (999999999999999999999999999999, b"999999999999999999999999999999"),
            (1000000000000000000000000000000, b"1000000000000000000000000000000"),
            (1000000000000000000000000000001, b"1000000000000000000000000000001"),
            (1000000000000000000000000000005, b"1000000000000000000000000000005"),
            (9999999999999999999999999999999, b"9999999999999999999999999999999"),
            (10000000000000000000000000000000, b"10000000000000000000000000000000"),
            (10000000000000000000000000000001, b"10000000000000000000000000000001"),
            (10000000000000000000000000000005, b"10000000000000000000000000000005"),
            (99999999999999999999999999999999, b"99999999999999999999999999999999"),
            (100000000000000000000000000000000, b"100000000000000000000000000000000"),
            (100000000000000000000000000000001, b"100000000000000000000000000000001"),
            (100000000000000000000000000000005, b"100000000000000000000000000000005"),
            (999999999999999999999999999999999, b"999999999999999999999999999999999"),
            (1000000000000000000000000000000000, b"1000000000000000000000000000000000"),
            (1000000000000000000000000000000001, b"1000000000000000000000000000000001"),
            (1000000000000000000000000000000005, b"1000000000000000000000000000000005"),
            (9999999999999999999999999999999999, b"9999999999999999999999999999999999"),
            (10000000000000000000000000000000000, b"10000000000000000000000000000000000"),
            (10000000000000000000000000000000001, b"10000000000000000000000000000000001"),
            (10000000000000000000000000000000005, b"10000000000000000000000000000000005"),
            (99999999999999999999999999999999999, b"99999999999999999999999999999999999"),
            (100000000000000000000000000000000000, b"100000000000000000000000000000000000"),
            (100000000000000000000000000000000001, b"100000000000000000000000000000000001"),
            (100000000000000000000000000000000005, b"100000000000000000000000000000000005"),
            (999999999999999999999999999999999999, b"999999999999999999999999999999999999"),
            (1000000000000000000000000000000000000, b"1000000000000000000000000000000000000"),
            (1000000000000000000000000000000000001, b"1000000000000000000000000000000000001"),
            (1000000000000000000000000000000000005, b"1000000000000000000000000000000000005"),
            (9999999999999999999999999999999999999, b"9999999999999999999999999999999999999"),
            (10000000000000000000000000000000000000, b"10000000000000000000000000000000000000"),
            (10000000000000000000000000000000000001, b"10000000000000000000000000000000000001"),
            (10000000000000000000000000000000000005, b"10000000000000000000000000000000000005"),
            (99999999999999999999999999999999999999, b"99999999999999999999999999999999999999"),
            (100000000000000000000000000000000000000, b"100000000000000000000000000000000000000"),
            (100000000000000000000000000000000000001, b"100000000000000000000000000000000000001"),
            (100000000000000000000000000000000000005, b"100000000000000000000000000000000000005"),
            (170141183460469231731687303715884105727, b"170141183460469231731687303715884105727"),
            (170141183460469231731687303715884105728, b"170141183460469231731687303715884105728"),
            (340282366920938463463374607431768211455, b"340282366920938463463374607431768211455"),
        ];
        for (i, s) in values.iter() {
            check_internal!(*i, s, u128toa, u128);
        }
    }
}
