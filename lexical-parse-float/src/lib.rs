...
//! # Design
//!
//! - [Algorithm Approach](https://github.com/Alexhuszagh/rust-lexical-experimental/blob/main/lexical-parse-float/docs/Algorithm.md)
//! - [Benchmarks](https://github.com/Alexhuszagh/rust-lexical-experimental/blob/main/lexical-parse-float/docs/Benchmarks.md)
//! - [Big Integer Implementation](https://github.com/Alexhuszagh/rust-lexical-experimental/blob/main/lexical-parse-float/docs/BigInteger.md)
