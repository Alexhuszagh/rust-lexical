...
fn main() -> ExitCode {
    ...
    if args.iter().any(|arg| arg == "--list") {
        let tests = tpr::register_tests(&tpr::Config::default());
    ...
    tpr::run(cfg, &include, &exclude)
}

/// Simple command argument parser
fn parse_args(args: Vec<String>) -> (tpr::Config, Vec<String>, Vec<String>) {
    let mut cfg = tpr::Config::default();
