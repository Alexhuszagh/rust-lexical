...
fn denormal10(bench: &mut Bencher) {
    ...
    bench.iter(|| {
        black_box(atof64(data[0].as_bytes()).unwrap());
    })
}
...
fn denormal20(bench: &mut Bencher) {
    let data: &[String] = &DENORMAL_DATA;
    bench.iter(|| {
        black_box(atof64(data[1].as_bytes()).unwrap());
    })
}
...
fn denormal30(bench: &mut Bencher) {
    let data: &[String] = &DENORMAL_DATA;
    bench.iter(|| {
        black_box(atof64(data[2].as_bytes()).unwrap());
    })
}
...
fn denormal40(bench: &mut Bencher) {
    let data: &[String] = &DENORMAL_DATA;
    bench.iter(|| {
        black_box(atof64(data[3].as_bytes()).unwrap());
    })
}
...
fn denormal50(bench: &mut Bencher) {
    let data: &[String] = &DENORMAL_DATA;
    bench.iter(|| {
        black_box(atof64(data[4].as_bytes()).unwrap());
    })
}
...
fn denormal100(bench: &mut Bencher) {
    let data: &[String] = &DENORMAL_DATA;
    bench.iter(|| {
        black_box(atof64(data[5].as_bytes()).unwrap());
    })
}
...
fn denormal200(bench: &mut Bencher) {
    let data: &[String] = &DENORMAL_DATA;
    bench.iter(|| {
        black_box(atof64(data[6].as_bytes()).unwrap());
    })
}
...
fn denormal400(bench: &mut Bencher) {
    let data: &[String] = &DENORMAL_DATA;
    bench.iter(|| {
        black_box(atof64(data[7].as_bytes()).unwrap());
    })
}
...
fn denormal800(bench: &mut Bencher) {
    let data: &[String] = &DENORMAL_DATA;
    bench.iter(|| {
        black_box(atof64(data[8].as_bytes()).unwrap());
    })
}
...
fn denormal1600(bench: &mut Bencher) {
    let data: &[String] = &DENORMAL_DATA;
    bench.iter(|| {
        black_box(atof64(data[9].as_bytes()).unwrap());
    })
}
...
fn denormal3200(bench: &mut Bencher) {
    let data: &[String] = &DENORMAL_DATA;
    bench.iter(|| {
        black_box(atof64(data[10].as_bytes()).unwrap());
    })
}
...
fn denormal6400(bench: &mut Bencher) {
    let data: &[String] = &DENORMAL_DATA;
    bench.iter(|| {
        black_box(atof64(data[11].as_bytes()).unwrap());
    })
}
...
fn digits2(bench: &mut Bencher) {
    ...
    bench.iter(|| {
        for value in data.iter() {
            black_box(atof64(value.as_bytes()).unwrap());
        }
    })
}
