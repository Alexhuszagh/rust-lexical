...
#![cfg_attr(
    not(feature = "nightly"),
    doc = " - [Algorithm Approach](https://github.com/Alexhuszagh/rust-lexical-experimental/blob/main/lexical-write-float/docs/Algorithm.md)"
)]
//!
#![cfg_attr(
    not(feature = "nightly"),
    doc = " - [Benchmarks](https://github.com/Alexhuszagh/rust-lexical-experimental/blob/main/lexical-write-float/docs/Benchmarks.md)"
)]
