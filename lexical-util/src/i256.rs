...
// TODO: Will need additional trait impls like Neg
...
const fn div(lhs: i256, rhs: i256) -> i256 {
    let (lo, hi, _) = math::div_i128(lhs.lo, lhs.hi, rhs.lo, rhs.hi);
    i256 { lo, hi }
}
...
const fn rem(lhs: i256, rhs: i256) -> i256 {
    let (lo, hi, _) = math::rem_i128(lhs.lo, lhs.hi, rhs.lo, rhs.hi);
    i256 { lo, hi }
}
...
// TODO: Fix, this is all wrong... should be a bitwise not then comparison
/// Const implementation of `PartialOrd::lt` for internal algorithm use.
const fn lt(lhs: i256, rhs: i256) -> bool {
    // TODO: CHECK VALIDITY
    // Document the two's complement structure here...
